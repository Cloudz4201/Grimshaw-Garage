...
const Volkswagen = () => {
  ...
  const services = [
    "German Engineering Service",
    "TSI & TDI Engine Care", 
    "DSG Transmission Service",
    "Golf & Passat Specialists",
    "4MOTION All-Wheel Drive",
    "Infotainment System Updates",
    "Reliable Daily Driver Care",
    "Precision German Maintenance"
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium border border-white/20">
                German Engineering Specialists
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="block text-white">VOLKSWAGEN</span>
              ...
              <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed">
                Das Auto. Experience precision German engineering service 
                that matches Volkswagen's commitment to reliability and innovation.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              From Wolfsburg's precision manufacturing to everyday reliability, 
              our German engineering specialists understand the heart of every Volkswagen.
            </p>
          </div>
          ...
          <div className="mt-16 text-center bg-slate-700 rounded-2xl p-12 border border-slate-600">
            <h3 className="text-3xl font-bold text-white mb-4">
              Precision German Service
            </h3>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Your Volkswagen represents decades of German engineering excellence and innovation. 
              Our service maintains that legendary reliability.
            </p>
            <Button 
              size="lg"
              onClick={() => setIsBookingModalOpen(true)}
