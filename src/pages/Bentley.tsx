...
const Bentley = () => {
  ...
  const services = [
    "Handcrafted Luxury Care",
    "Bentley Flying Spur Service", 
    "Continental GT Specialists",
    "Mulliner Bespoke Care",
    "W12 Engine Specialists",
    "Luxury Interior Restoration",
    "Concierge Service Programs",
    "Heritage Vehicle Care"
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="block text-white">BENTLEY</span>
              ...
              <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed">
                Be Extraordinary. Experience ultra-luxury automotive care 
                that matches Bentley's century of craftsmanship excellence.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">
              Bentley Ultra-Luxury Service
            </h2>
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Crewe craftsmanship meets modern excellence. Our ultra-luxury specialists 
              understand the artistry behind every Bentley.
            </p>
          </div>
          ...
          <div className="mt-16 text-center bg-slate-700 rounded-2xl p-12 border border-slate-600">
            <h3 className="text-3xl font-bold text-white mb-4">
              Extraordinary Service Standards
            </h3>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Your Bentley represents a century of luxury automotive craftsmanship. 
              Our service standards honor that extraordinary heritage.
            </p>
            <Button 
              size="lg"
              onClick={() => setIsBookingModalOpen(true)}
