...
const Lamborghini = () => {
  ...
  const services = [
    "Exotic Supercar Service",
    "V10 & V12 Engine Specialists", 
    "All-Wheel Drive Systems",
    "Carbon Fiber Maintenance",
    "Track Performance Tuning",
    "Exotic Component Care",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium border border-white/20">
                Exotic Service Specialists
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="block text-white">LAMBORGHINI</span>
              ...
              <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed">
                Raging bull performance demands exceptional care. 
                Experience exotic service that matches Lamborghini's wild spirit.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">
              Lamborghini Exotic Service
            </h2>
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Sant'Agata Bolognese engineering meets uncompromising performance. 
              Our exotic specialists understand every roar of the raging bull.
            </p>
          </div>
          ...
          <div className="mt-16 text-center bg-slate-700 rounded-2xl p-12 border border-slate-600">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Your Lamborghini represents pure automotive passion and exotic engineering. 
              Our service unleashes its full potential.
            </p>
            <Button 
              size="lg"
              onClick={() => setIsBookingModalOpen(true)}
