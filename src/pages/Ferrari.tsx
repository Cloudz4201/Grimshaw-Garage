...
const Ferrari = () => {
  ...
  const services = [
    "Supercar Performance Tuning",
    "V8 & V12 Engine Specialists", 
    "Track Day Preparation",
    "Carbon Fiber Care",
    "Advanced Diagnostics",
    "Racing Technology Service",
    "Exotic Component Maintenance",
    ...
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden pt-20">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1544829099-b9a0c5303bea?w=2560&q=80')`
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium border border-white/20">
                Supercar Care Specialists
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                <span className="block text-white">FERRARI</span>
              ...
              <p className="text-xl lg:text-2xl text-slate-300 leading-relaxed">
                The prancing horse deserves nothing less than perfection. 
                Experience supercar care that matches Ferrari's legendary passion.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-white">
              Ferrari Supercar Care
            </h2>
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">
              Racing heritage meets street performance. Our Ferrari specialists 
              understand the engineering excellence behind every prancing horse.
            </p>
          </div>
          ...
          <div className="mt-16 text-center bg-slate-700 rounded-2xl p-12 border border-slate-600">
            <h3 className="text-3xl font-bold text-white mb-4">
              Legendary Performance Care
            </h3>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Your Ferrari represents decades of racing heritage and engineering excellence. 
              Our care reflects that legendary standard.
            </p>
            <Button 
              size="lg"
              onClick={() => setIsBookingModalOpen(true)}
